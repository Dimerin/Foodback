...
class HeartRateRepository(private val context: Context) {
    ...
    private val _collectedHeartRates = Collections.synchronizedList(mutableListOf<Float>())
    val collectedHeartRates: List<Float> get() = _collectedHeartRates

    private val _collectedEDA = Collections.synchronizedList(mutableListOf<Float>())
