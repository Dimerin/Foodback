package unipi.msss.foodback.data.network.http
...
class FoodbackHttpClientBuilder @Inject constructor(
    ...
    fun build(): HttpClient {
        client = HttpClient(Android) {
            ...
            defaultRequest {
                url {
                    protocol = this@FoodbackHttpClientBuilder.protocol
                    host = this@FoodbackHttpClientBuilder.host
                }
